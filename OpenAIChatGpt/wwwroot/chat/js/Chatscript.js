       ...
       await addChatMessage("User", message);
        ...
        if (isstream.checked) {
            try {
                ...
                //const apikey = "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"home/RelayAsync;
                stream = await getChatCompletionStream("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", "Home/ProxyToC", chatMessages);
                ...
                try {
                    ...
                    if (selectedVoice !== '请选择') {
                        ...
                        const base64 = await postFunc("home/GetPollyBaseStr", data);
...
function initPollySelect(){
    
  
    $.post("home/GetPollyVoice").done(function (response) {
 ...
 async function addChatMessage(role, content) {
    ...
    console.log(selectedVoice)
     if (selectedVoice != '请选择') {
             ...
             if (playAudio.src === '' && content.trim() !== '' && role == "Assistant") {
